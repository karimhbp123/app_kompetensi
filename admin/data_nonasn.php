  ...
  <div class="content">
    <div class="header-box">
      <div class="header-content">
        <div class="header-text">
          <h2 class="welcome">👋<span class="highlight">Data Pegawai Non ASN</span></h2>
          <p class="subtext">Selamat datang kembali di data pegawai non ASN. Yuk produktif hari ini 💪</p>
        </div>
        <div class="clock-box">
    ...
    <div class="table-container">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <a href="download_excel.php?role=nonasn" class="download-btn">⬇️ Download Excel</a>
      </div>
      <table>
        <thead>
          <tr>
