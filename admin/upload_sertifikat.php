...
$query = "SELECT diklat.*, users.nama, users.nip 
          FROM diklat 
          JOIN users ON diklat.user_id = users.id 
          WHERE DATE(diklat.created_at) = '$today'
          AND diklat.created_by = 'admin'
    ...
    <div class="content">
        <div class="header-box">
            <div class="header-content">
                <div class="header-text">
                    <h2 class="welcome">👋<span class="highlight">Data Upload Sertifikat Pegawai</span></h2>
                    <p class="subtext">Selamat datang kembali di data upload sertifikat pegawai. Yuk produktif hari ini 💪</p>
                </div>
                <div class="clock-box">
        ...
        <div class="table-container">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                <div>
                    <a href="add_sertifikat.php" class="download-btn" style="background-color: #3b82f6; margin-right: 10px;">➕ Tambah Data Sertifikat</a>
                </div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <?php
                    function namaToFolder($nama)
                    {
                        $folder = strtolower($nama);
                    ...
                    while ($row = mysqli_fetch_assoc($result)) :
                        ...
                        $folderUser = namaToFolder($row['nama']);
                        $fileSertifikat = $row['file_sertifikat'];
                        $linkFile = "/app_kompetensi/sertifikat/" . urlencode($folderUser) . "/" . rawurlencode($fileSertifikat);
                    ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            ...
                            <td class="no-sertifikat"><?= htmlspecialchars($row['no_sertifikat']) ?></td>
                            ...
                            <td>
                                <?php if ($fileSertifikat) : ?>
                                    <a href="#" class="badge-view" data-img="<?= htmlspecialchars($linkFile) ?>">
    ...
    <script>
        ...
        viewLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                console.log('Open file:', filePath); // debug
